        ...
        <section className="sneakers">
            <div className="sneakers_top">
                ...
                <label className="search">
                    <svg className="search_btn" onClick={()=>dispatch(sneakersActions.searchSneakers(query))} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
